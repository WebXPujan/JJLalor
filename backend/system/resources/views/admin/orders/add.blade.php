            ...
            <div class="col-md-9">
                <form action="{{route('admin.orders.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row {{$errors->has('address_one') ?'has-error' :''}}">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text"  name="address_one" required>
                    ...
                    <div class="form-group row {{$errors->has('address_three') ?'has-error' :''}}">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text"  name="address_three">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <x-adminlte-text-editor name="product_html" required/>
                        </div>
                    </div>

                    <div class="form-group row {{$errors->has('product_image_pdf') ?'has-error' :''}}">
                        <label class="col-2 col-form-label">Insert Product Image</label>
                        <div class="col-10">
                            <input class="form-control" type="file" name="product_image_pdf" required>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success" value="add">Add New Order</button>
                    </div>
